...
const CountryCodeCard = ({flag, country, code, onPress}) => {
  return (
    <TouchableOpacity onPress={() => onPress(flag)} activeOpacity={0.5} style={tw`flex-row items-center `}>
      <View
        style={tw`flex-row items-center bg-[#101214] rounded-[13px] w-full h-17.5 mb-7 px-1 font-dm text-[14px] font-bold tracking-[0.5px]`}>
...
const AuthStack_CountryScreen: React.FC<Props> = ({navigation, route}) => {
  ...
  return (
      <View  style={tw`flex-1 justify-center items-center bg-black`}>
          <ScrollView>
            <View style={tw`mt-5 mb-10 flex-row items-center justify-center`}>
